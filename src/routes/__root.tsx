  ...
  head: () => ({
    meta: [
      ...
      { title: "Whisky Hub Rongai — Premium Liquor Delivery in Nairobi" },
      {
        name: "description",
        content:
          "Rongai's premium liquor store. Whisky, wines, vodka, gin, champagne & more delivered same-day across Nairobi. Order via WhatsApp.",
      },
      ...
      },
      {
        property: "og:image",
        content:
          "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/e5319f02-2ae1-4e14-b28c-80408865ca22",
      },
      {
        name: "twitter:image",
        content:
